...
<%
   ...
   try{
       ...
       String sql = "select * from company where c_uname = ? and c_pass = ?";
       ...
       if(rs.next())
       {
         ...
         session.setAttribute("current_user_name", rs.getString(7));
         session.setAttribute("comp_id",rs.getInt("c_id"));
